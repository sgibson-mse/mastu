...
from cherab.mastu.bolometry.grid_construction.core_high_res_rectilinear_reference_grid import CORE_RECTILINEAR_REFERENCE_GRID
...
# For this many cells, a sparse matrix is required
grid_laplacian = sparse.lil_matrix((num_cells, num_cells))
...
grid_laplacian = grid_laplacian.tocsr()
...
file_name = "core_high_res_rectilinear_grid.pickle"
